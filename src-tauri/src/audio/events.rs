...
pub struct GaplessPreloadIdentity {
    pub preload_id: String,
    pub generation: u64,
    pub path: String,
}
...
#[serde(rename_all = "camelCase")]
pub struct GaplessHandoff {
    pub outgoing_path: String,
    pub outgoing_generation: u64,
    pub preload: GaplessPreloadIdentity,
}

#[derive(Debug, Clone, Serialize, PartialEq, Eq)]
#[serde(tag = "status", rename_all = "camelCase")]
pub enum GaplessCancellationOutcome {
    Cancelled { preload: GaplessPreloadIdentity },
    HandedOff { handoff: GaplessHandoff },
    Stale { preload: GaplessPreloadIdentity },
}
...
pub struct PlaybackEndedPayload {
    ...
    #[serde(default)]
    pub seamless: bool,
    pub handoff: Option<GaplessHandoff>,
}
