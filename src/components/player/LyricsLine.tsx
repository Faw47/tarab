  ...
  ({
    ...
    return (
      <div
        ref={containerRef}
        className={clsx(
          'transition-[transform,opacity] duration-[var(--motion-standard)] ease-out w-full py-2',
          textAlign,
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{
                        ...
                        color: 'transparent',
                        transition:
                          'text-shadow var(--motion-standard) var(--motion-ease-standard), filter var(--motion-standard) var(--motion-ease-standard)',
                      }}
                    >
                      {word.text}
                    </span>
