...
const { captureActivePlaybackSourceMock } = vi.hoisted(() => ({
  captureActivePlaybackSourceMock: vi.fn(() => ({ trackId: 'track-1', generation: 7 })),
}));
...
describe('HidingProgressBar', () => {
  beforeEach(() => {
    ...
    captureActivePlaybackSourceMock.mockReturnValue({ trackId: 'track-1', generation: 7 });
  ...
  it('previews pointer movement locally and sends one seek when the drag ends', () => {
    ...
    captureActivePlaybackSourceMock.mockReturnValue({ trackId: 'replacement', generation: 8 });
