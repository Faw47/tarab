        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              <label htmlFor="tag-editor-title" className="block text-sm text-text-secondary mb-1">
                Title
              </label>
              <Input
                id="tag-editor-title"
            ...
            <div>
              <label htmlFor="tag-editor-artist" className="block text-sm text-text-secondary mb-1">
                Artist
              </label>
              <Input
                id="tag-editor-artist"
                type="text"
                value={artist}
            ...
            <div>
              <label
                htmlFor="tag-editor-album-artist"
                className="block text-sm text-text-secondary mb-1"
              >
                Album Artist
              </label>
              <Input
                id="tag-editor-album-artist"
                type="text"
                value={albumArtist}
            ...
            <div className="md:col-span-2">
              <label htmlFor="tag-editor-album" className="block text-sm text-text-secondary mb-1">
                Album
              </label>
              <Input
                id="tag-editor-album"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="tag-editor-genre" className="block text-sm text-text-secondary mb-1">
                Genre
              </label>
              <Input
                id="tag-editor-genre"
            ...
            <div>
              <label htmlFor="tag-editor-year" className="block text-sm text-text-secondary mb-1">
                Year
              </label>
              <Input
                id="tag-editor-year"
            ...
            <div>
              <label
                htmlFor="tag-editor-track-number"
                className="block text-sm text-text-secondary mb-1"
              >
                Track #
              </label>
              <Input
                id="tag-editor-track-number"
                type="number"
                value={trackNumber}
            ...
            <div>
              <label
                htmlFor="tag-editor-disc-number"
                className="block text-sm text-text-secondary mb-1"
              >
                Disc #
              </label>
              <Input
                id="tag-editor-disc-number"
                type="number"
                value={discNumber}
            ...
            <div>
              <label
                htmlFor="tag-editor-composer"
                className="block text-sm text-text-secondary mb-1"
              >
                Composer
              </label>
              <Input
                id="tag-editor-composer"
                type="text"
                value={composer}
          ...
          <div>
            <label htmlFor="tag-editor-comment" className="block text-sm text-text-secondary mb-1">
              Comment
            </label>
            <textarea
              id="tag-editor-comment"
              value={comment}
                ...
                {extendedFields.length === 0 ? (
                  ...
                  extendedFields.map((tag, i) => (
                    <tr key={`${tag.key}-${i}`} className="group hover:bg-white/5">
                      <td className="p-3">
                        <Input
                          aria-label={`Extended tag ${i + 1} name`}
                          value={tag.key}
                      ...
                      <td className="p-3">
                        <Input
                          aria-label={`Extended tag ${i + 1} value`}
                          value={tag.value}
