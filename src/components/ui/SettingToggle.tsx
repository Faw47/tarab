    ...
    <div className={cn('flex items-center justify-between py-3 group', className)}>
      ...
      <button
        ...
        className={cn(
          ...
          isNeobrutalism
            ? cn(
                'relative h-9 min-w-[4.5rem] shrink-0 overflow-visible rounded-none border-[3px] border-[var(--neo-ink)] px-3 text-[12px] font-black uppercase tracking-[0.14em] text-[var(--neo-ink)] shadow-[var(--neo-shadow-md)] transition-none',
                'focus-visible:ring-black focus-visible:ring-offset-2 focus-visible:ring-offset-white',
                'active:translate-x-[3px] active:translate-y-[3px] active:shadow-none',
                checked ? 'bg-[var(--signal-play)]' : 'bg-[var(--neo-paper)]',
              )
            : cn(
