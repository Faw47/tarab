        ...
        >
          ...
          >
            <SliderPrimitive.Range
              ...
              className="absolute rounded-full bg-gradient-to-r from-primary via-accent to-primary-light transition-all duration-75 data-[orientation=horizontal]:h-full data-[orientation=vertical]:w-full"
            />
          </SliderPrimitive.Track>
          ...
          {Array.from({ length: values.length }, (_, index) => (
            <SliderPrimitive.Thumb
              ...
              className={cn(
                ...
                'transition-all duration-150 ease-out hover:scale-105 hover:ring-4 hover:ring-primary/25 focus-visible:ring-4 focus-visible:ring-primary/30 focus-visible:outline-none',
