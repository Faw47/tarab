...
export const liquidGlassSettingsSelectClassName = (className?: string) =>
  cn(
    'w-full appearance-none px-4 py-2.5 pr-10 outline-none transition-[color,background-color,border-color,opacity,box-shadow,transform,width,height,left,right,top,bottom] cursor-pointer',
